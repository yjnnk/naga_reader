# 07 — Adicionar paginação simples como modo padrão

**What to build:** O modo padrão passa a ser paginação simples por capítulo, com controles anterior/próximo e navegação básica por teclado.
